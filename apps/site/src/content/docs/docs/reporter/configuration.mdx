...
| `target`         | string   | _none_                           | Deployment label for separate-repo flows (`"prod"`, `"staging"`, `"app@1.42.0"`). Empty for same-repo flows. |
...
- [Reporter overview](/docs/reporter/overview) for what each
  reporter does and how they group runs.
- [Installation](/docs/installation) for the one-line install or
  manual Docker Compose walkthrough.
