...
Brittle's reporter runs in parallel with `list` / `html` / `dot` —
none of them interact. You don't need to drop your existing
reporters.
...
The reporter doesn't enable any of these for you — they remain
